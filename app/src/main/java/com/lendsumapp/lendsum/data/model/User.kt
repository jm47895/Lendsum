...
data class User(
    ...
    @get: Exclude @ColumnInfo(name = "karmaScore") var karmaScore: Int = 0,
    //TODO Change to type Friend object when feature is implemented
    @get: Exclude @ColumnInfo(name = "friendsList") var friendList: List<String>? = emptyList(),
    @get: Exclude @ColumnInfo(name = "isProfilePublic") var isProfilePublic: Boolean = true
)